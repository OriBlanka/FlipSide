 ...
 * Use the {@link HelathNewsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HelathNewsFragment extends Fragment {
    ...
    private static final String TAG = "HealthNewsPage";
     ...
     * @return A new instance of fragment HelathNewsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static HelathNewsFragment newInstance(String param1, String param2) {
        HelathNewsFragment fragment = new HelathNewsFragment();
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    if (subjectCategory.equals("בריאות")) {
