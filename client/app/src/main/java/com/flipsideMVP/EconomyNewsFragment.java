 ...
 * Use the {@link EconomyNewsFragment#newInstance} factory method to
...
public class EconomyNewsFragment extends Fragment {
    ...
    private static final String TAG = "EconomyNewsPage";
     ...
     * @return A new instance of fragment EconomyNewsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static EconomyNewsFragment newInstance(String param1, String param2) {
        EconomyNewsFragment fragment = new EconomyNewsFragment();
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    if (subjectCategory.equals("כלכלה")) {
