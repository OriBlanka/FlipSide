 ...
 * Use the {@link PoliticalNewsFragment#newInstance} factory method to
...
public class PoliticalNewsFragment extends Fragment {
    ...
    public static PoliticalNewsFragment newInstance(String param1, String param2) {
        PoliticalNewsFragment fragment = new PoliticalNewsFragment();
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    if (subjectCategory.equals("פוליטי")) {
