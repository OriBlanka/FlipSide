 ...
 * Use the {@link SecurityNewsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SecurityNewsFragment extends Fragment {
    ...
    private static final String TAG = "SecurityNewsPage";
     ...
     * @return A new instance of fragment SecurityNewsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SecurityNewsFragment newInstance(String param1, String param2) {
        SecurityNewsFragment fragment = new SecurityNewsFragment();
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    if (subjectCategory.equals("ביטחון")) {
