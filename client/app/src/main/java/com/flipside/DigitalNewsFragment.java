 ...
 * Use the {@link DigitalNewsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DigitalNewsFragment extends Fragment {
    ...
    private static final String TAG = "DigitalNewsPage";
     ...
     * @return A new instance of fragment DigitalNewsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static DigitalNewsFragment newInstance(String param1, String param2) {
        DigitalNewsFragment fragment = new DigitalNewsFragment();
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    if (subjectCategory.equals("דיגיטל וטכנולוגיה")) {
